...
func GetFilmReviewByID(ctx context.Context, id int) (*FilmReview, error) {
	review, err := Get[FilmReview](ctx, "SELECT id, film_id, watched_date, rating, is_rewatch, has_spoilers, review_text, published FROM film_reviews WHERE id = $1", id)
	if err != nil {
		return nil, err
	}
	return &review, nil
...
func GetFilmReviewsByFilmID(ctx context.Context, filmID int) ([]FilmReview, error) {
	return Select[FilmReview](ctx, "SELECT id, film_id, watched_date, rating, is_rewatch, has_spoilers, review_text, published FROM film_reviews WHERE film_id = $1 ORDER BY watched_date DESC", filmID)
}
...
func GetAllPublishedFilmReviewsWithFilmAndPosters(ctx context.Context) ([]FilmReviewWithFilmAndPoster, error) {
	...
	return Select[FilmReviewWithFilmAndPoster](ctx, query)
}
...
func GetRecentPublishedFilmReviewsWithFilmAndPosters(ctx context.Context, limit int) ([]FilmReviewWithFilmAndPoster, error) {
	...
	return Select[FilmReviewWithFilmAndPoster](ctx, query, limit)
}
