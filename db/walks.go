...
// GetMonthlyMaxWalkingSpeed returns the maximum walking speed (km/h) for each month
func GetMonthlyMaxWalkingSpeed(ctx context.Context) ([]MonthlyWalkingSpeed, error) {
	metrics.LogQuery(ctx)
